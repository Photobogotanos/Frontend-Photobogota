...
const comentariosMock = {
  ...
  3: [
    { id: 5, usuario: "Diego Torres", texto: "Vamos! 🔥", tiempo: "5h", avatar: "/images/user-pfp/fotouserdemo.jpg" }
  ],
  4: [
    { id: 6, usuario: "Sofia Ramírez", texto: "Necesito ir ahí!", tiempo: "7h", avatar: "/images/user-pfp/fotouserdemo.jpg" },
    { id: 7, usuario: "Juan Castro", texto: "Impresionante!", tiempo: "6h", avatar: "/images/user-pfp/fotouserdemo.jpg" }
  ]
};
