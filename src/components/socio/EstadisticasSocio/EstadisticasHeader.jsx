...
const EstadisticasHeader = ({ periodo, setPeriodo }) => {
  return (
    <div className="estadisticas-header">
      <div className="estadisticas-header-superior">
        <div className="header-info">
          <span className="estadisticas-top-text">Resumen de tu negocio</span>
          <h1 className="header-titulo">
            <FaChartLine className="header-icon" />
            Estadísticas de tu Negocio
          </h1>
          <p className="header-subtitulo">
            Monitora el rendimiento de tus lugares y promociones
          </p>
        </div>
      ...
      <span className="estadisticas-header-line" />
    </div>
  );
};
